...
public class TestHdfs {
    ...
    public void testUploadFile(){
        //测试上传三个文件
        hdfsService.uploadFileToHdfs("/Users/chenxiong/大数据学习/files/a.txt","/testDir");
        hdfsService.uploadFileToHdfs("/Users/chenxiong/大数据学习/files/b.txt","/testDir");

        hdfsService.uploadFileToHdfs("/Users/chenxiong/大数据学习/files/c.txt","/testDir/subDir");
    }
    ...
    public void testDownloadFile(){
        hdfsService.downloadFileFromHdfs("/testDir/a.txt","/Users/chenxiong/大数据学习/files/d.txt");
    }
